...
If the user/human OR the spec says/implies the task is huge/big/large/long-horizon (i.e. unlikely to fit safely in one context window), do NOT try to implement it all in one run.
