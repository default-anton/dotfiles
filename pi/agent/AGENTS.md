...
- If the project says it contains AGENTS.md in subdirectories, always run `fd AGENTS.md` and read the relevant ones for additional rules or context for that subdirectory
