...
- For subagents, use `openai/gpt-5.6-luna:high` for reconnaissance/exploration/context gathering, `openai/gpt-5.6-sol:medium` for code/security review. If not specified, omit the model.
