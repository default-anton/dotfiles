...
- Subagents: use `model: openai-codex/gpt-5.4-mini:high` for `run_subagent` unless the user explicitly asks for a different model, or instructed otherwise in project's AGENTS file.
