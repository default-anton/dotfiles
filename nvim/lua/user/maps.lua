...
vim.api.nvim_set_keymap('n', '<leader>ao', '<cmd>Ask gpt-4-turbo-2024-04-09<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', '<leader>ao', ':\'<,\'>Ask gpt-4-turbo-2024-04-09<CR>', { noremap = true, silent = true })
