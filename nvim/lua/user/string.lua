...
local function convert_case(motion_type, converter)
  ...
  elseif motion_type == 'block' then
    ...
    for line = start_line, end_line do
      ...
      local converted_text = converter(text_to_convert)
  ...
  local converted_text = converter(text)
...
_G.convert_to_mixed_case_opfunc = function(motion_type)
  convert_case(motion_type, to_mixed_case)
end

_G.convert_to_camel_case_opfunc = function(motion_type)
  convert_case(motion_type, to_camel_case)
end
