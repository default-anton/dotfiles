...
if command == "gh":
    ...
    elif args[:2] == ["workspace", "create"] and "--no-focus" in args:
...
'''
    ...
    def run_script(self, url=PR_URL, succeeds=True):
    ...
    def test_reuses_space_with_pane_in_worktree_subdirectory(self):
        ...
        self.assertEqual([call for call in calls if call[0] == "herdr"], [["herdr", "pane", "list"]])
